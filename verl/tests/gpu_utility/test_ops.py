...
def test_flash_attn_cross_entropy():
    ...
    hidden_states = torch.randn(size=(2048, 5120), device='cuda', requires_grad=True, dtype=torch.float16)

    linear = nn.Linear(in_features=5120, out_features=155136, bias=False, device='cuda', dtype=torch.float16)
